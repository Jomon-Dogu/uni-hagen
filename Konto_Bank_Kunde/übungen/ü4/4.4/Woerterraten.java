...
public class Woerterraten {
	...
	void aktualisiereLoesung(char c) {
		// TODO
            ...
            // Iteriere über das zuRatendesWort
    for (int i = 0; i < zuRatendesWort.length(); i++) {
        // Prüfe, ob das Zeichen c an der aktuellen Position i in zuRatendesWort vorkommt
        if (zuRatendesWort.charAt(i) == c) {
            // Ersetze das Zeichen an Position i in erratenesWort durch c
